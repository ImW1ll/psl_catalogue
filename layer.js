...
function createLayerGrip() {
  ...
  el.innerHTML = '<div id="pcg-handle" class="pcg-handle" style="display:none; position: fixed; top: 0; right: 0;">' +
    '<div class="upper_tab">' +
    '<div id="pcg-handle-text"><span id="tab_text" class="theme-tabfontcolor theme-fontname">spare parts</span></div>' +
    '</div>' +
    '<div class="lower_tab">' +
    '<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 44 64" style="enable-background:new 0 0 44 64;" xml:space="preserve">' +
    '<g class="theme-tabiconcolor">' +
    '<path d="M14.7,5.7c-2.5,2.5-2.5,6.6,0,9.1c2.4,2.4,6.2,2.5,8.7,0.4l1.6,1.6c-0.2,0.5-0.1,1.2,0.3,1.6l5.3,5.3c0.6,0.6,1.5,0.6,2.1,0c0.6-0.6,0.6-1.5,0-2.1l-5.3-5.3c-0.4-0.4-1.1-0.5-1.6-0.3l-1.6-1.6c1-1.2,1.5-2.7,1.5-4.1c0-1.6-0.6-3.3-1.9-4.5C21.3,3.2,17.2,3.2,14.7,5.7z M22.2,7.3c1.6,1.6,1.6,4.3,0,6c-1.6,1.6-4.3,1.6-6,0c-0.8-0.8-1.2-1.9-1.2-3c0-1.1,0.4-2.2,1.2-3C17.9,5.6,20.6,5.6,22.2,7.3z"/>' +
    '<path d="M30.2,41.8H15.2l-0.5-1.7c0,0,0,0,0,0c0,0,0-0.1,0-0.1c0,0,0-0.1,0-0.1c0,0,0-0.1-0.1-0.1c0,0,0-0.1-0.1-0.1c0,0,0-0.1-0.1-0.1c0,0,0,0-0.1-0.1c0,0,0-0.1-0.1-0.1c0,0,0-0.1-0.1-0.1c0,0-0.1,0-0.1-0.1c0,0-0.1,0-0.1,0c0,0-0.1,0-0.1,0c0,0-0.1,0-0.1,0c0,0,0,0,0,0c0,0,0,0,0,0l-2.6,0c-0.6,0-1.1,0.5-1.1,1.1c0,0.6,0.5,1.1,1.1,1.1c0,0,0,0,0,0l1.8,0l0.5,1.7c0,0,0,0,0,0l2.9,9.2c0.1,0.4,0.6,0.7,1,0.7c0.1,0,0.1,0,0.2,0l12.9-2.6c0.5-0.1,0.8-0.5,0.8-1v-6.6C31.3,42.3,30.8,41.8,30.2,41.8z M29.2,45.8L26,46l-0.1-2.1h3.3V45.8z M21.3,46.4l-0.4-2.5h3.9l0.1,2.2L21.3,46.4z M25,47.1l0.1,2.3l-3.3,0.7l-0.4-2.7L25,47.1z M19.8,43.9l0.4,2.5l-3.5,0.3l-0.9-2.8H19.8z M17,47.7l3.3-0.2l0.4,2.8L18,50.9L17,47.7zM26.2,49.2l-0.1-2.1l3.1-0.2v1.8L26.2,49.2z"/>' +
    '<path d="M30.4,54.2H15.2c-0.4,0-0.8,0.3-0.8,0.8s0.3,0.8,0.8,0.8h15.1c0.4,0,0.8-0.3,0.8-0.8S30.8,54.2,30.4,54.2z"/>' +
    '<path d="M16,56.8c-0.8,0-1.5,0.7-1.5,1.5s0.7,1.5,1.5,1.5s1.5-0.7,1.5-1.5S16.8,56.8,16,56.8z"/>' +
    '<path d="M29.6,56.8c-0.8,0-1.5,0.7-1.5,1.5s0.7,1.5,1.5,1.5c0.8,0,1.5-0.7,1.5-1.5S30.4,56.8,29.6,56.8z"/>' +
    '</g>' +
    '</svg>' +
    '</div></div>';
  return el;
